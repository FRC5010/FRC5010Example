...
public class SwerveModuleConfig {
  ...
  /**
   * Swerve module state optimization using {@link
   * edu.wpi.first.math.kinematics.SwerveModuleState#optimize(Rotation2d)}.
   */
   ...
   *     SmartMotorController)} BEFORE passed into {@link yams.mechanisms.swerve.SwerveModule}
   */
  ...
  /**
   * Cosine compensation for the {@link yams.mechanisms.swerve.SwerveModule}, adjusting the velocity
   * by the cosine of the (current_angle-desired_angle).
   *
  ...
  /**
   * Set the distance from the center of rotation for the {@link
  ...
  /**
   * Set the location for the {@link yams.mechanisms.swerve.SwerveModule} in Meters from the center
   * of rotation.
   *
   * @param location Location of the {@link yams.mechanisms.swerve.SwerveModule} in meters from the
   *     center of rotation.
   * @return {@link SwerveModuleConfig} for chaining.
   */
  ...
  /**
   * Get the azimuth {@link SmartMotorController} for the {@link
   * yams.mechanisms.swerve.SwerveModule}.
   *
  ...
  /**
   * Get the location of the {@link yams.mechanisms.swerve.SwerveModule} in meters from the center
   * of rotation.
   *
