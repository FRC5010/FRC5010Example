    ...
    for (Map.Entry<DoubleTelemetryField, DoubleTelemetry> entry : doubleFields.entrySet()) {
      ...
      if (dt.tunable()) {
        switch (dt.getField()) {
          ...
          case TunableSetpointVelocity -> {
            ...
            if (cfg.getLinearClosedLoopControllerUse()) {
              ...
              smartMotorController.setVelocity(
                  dt.get() == 0 ? null : RotationsPerSecond.of(dt.get()));
            }
            break;
          }
          ...
          case ClosedloopRampRate -> smartMotorController.setClosedLoopRampRate(
              Seconds.of(dt.get()));
          ...
          case MeasurementUpperLimit -> smartMotorController.setMeasurementUpperLimit(
              Meters.of(dt.get()));
          case MeasurementLowerLimit -> smartMotorController.setMeasurementLowerLimit(
              Meters.of(dt.get()));
          case MechanismUpperLimit -> smartMotorController.setMechanismUpperLimit(
              Degrees.of(dt.get()));
          case MechanismLowerLimit -> smartMotorController.setMechanismLowerLimit(
              Degrees.of(dt.get()));
