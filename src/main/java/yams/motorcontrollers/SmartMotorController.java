...
public abstract class SmartMotorController {
      ...
      if (armFeedforward.isPresent()) {
        ...
        feedforward =
            armFeedforward
                ...
                .calculateWithVelocities(
                    ...
                    m_expoPidController.get().getCurrentVelocitySetpoint().in(RadiansPerSecond),
                    m_expoPidController.get().getNextVelocitySetpoint().in(RadiansPerSecond));
        ...
        pidOutputVoltage.set(
            m_expoPidController
                ...
                .calculate(
                    getMeasurementPosition().in(Meters),
                    m_config.convertFromMechanism(setpointPosition.get()).in(Meters)));
        feedforward =
            elevatorFeedforward
                .get()
                .calculateWithVelocities(
                    m_config
                        .convertFromMechanism(
                            m_expoPidController.get().getCurrentVelocitySetpoint())
                        .in(MetersPerSecond),
                    m_config
                        .convertFromMechanism(m_expoPidController.get().getNextVelocitySetpoint())
                        .in(MetersPerSecond));
        ...
        feedforward =
            simpleMotorFeedforward
                .get()
                .calculateWithVelocities(
                    m_expoPidController.get().getCurrentVelocitySetpoint().in(RotationsPerSecond),
                    m_expoPidController.get().getNextVelocitySetpoint().in(RotationsPerSecond));
      }
      ...
      if (armFeedforward.isPresent()) {
        ...
        feedforward =
            armFeedforward
                ...
                .calculateWithVelocities(
                    ...
                    RotationsPerSecond.of(m_pidController.get().getSetpoint().velocity)
                        .in(RadiansPerSecond));
      } else if (elevatorFeedforward.isPresent()) {
        pidOutputVoltage.set(
            m_pidController
        ...
        feedforward =
            elevatorFeedforward
                ...
                .calculateWithVelocities(
                    getMeasurementVelocity().in(MetersPerSecond),
                    m_pidController.get().getSetpoint().velocity);
  ...
  /**
   * Get the SysIdConfig which may need to have modifications based on the SmartMotorController,
   * like TalonFX and TalonFXS to record states correctly.
   *
                  ...
                  .until(
                      () ->
                          velocityDebouncer.calculate(
                              ...
                              || currentDebouncer.calculate(getStatorCurrent().gte(Amps.of(40))))
