...
public class SmartMotorControllerTelemetryConfig {
    ...
    config
        ...
        .ifPresent(
            e -> {
              ...
              doubleFields.get(DoubleTelemetryField.kD).setDefaultValue(e.getD());
              doubleFields
                  .get(DoubleTelemetryField.MotionProfileMaxAcceleration)
                  .setDefaultValue(
                      RotationsPerSecondPerSecond.of(e.getConstraints().maxAcceleration)
                          .in(DegreesPerSecondPerSecond));
              doubleFields
                  .get(DoubleTelemetryField.MotionProfileMaxVelocity)
                  .setDefaultValue(
                      RotationsPerSecond.of(e.getConstraints().maxVelocity).in(DegreesPerSecond));
            });
    config
  ...
  public Map<BooleanTelemetryField, BooleanTelemetry> getBoolFields(SmartMotorController smc) {
    ...
    boolFields
        ...
        .setDefaultValue(config.getEncoderInverted());
    return boolFields;
  }
