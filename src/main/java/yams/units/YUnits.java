...
public class YUnits {
  ...
  /**
   * 101.6/1000 of a {@link edu.wpi.first.units.Units#Meters}, or 4 {@link
   * edu.wpi.first.units.Units#Inches}.
   */
  ...
  /**
   * 914.4/1000 of a {@link edu.wpi.first.units.Units#Meters}, or 3 {@link
   * edu.wpi.first.units.Units#Feet}.
   */
  ...
  /**
   * 457.2/1000 of a {@link edu.wpi.first.units.Units#Meters}, or 18 {@link
   * edu.wpi.first.units.Units#Inches}.
   */
  ...
  /**
   * 1609.344 {@link edu.wpi.first.units.Units#Meters}s, or 5280 {@link
   * edu.wpi.first.units.Units#Feet}.
   */
