...
public class DoubleJointedArm extends SmartPositionalMechanism {
  ...
  public DoubleJointedArm(ArmConfig lowerConfig, ArmConfig upperConfig) {
    ...
    if (lowerConfig.getMotor().getConfig().getSubsystem()
        != upperConfig.getMotor().getConfig().getSubsystem()) {
    ...
    if (m_lowerArmSim.isPresent()
      ...
      RoboRioSim.setVInVoltage(
          BatterySim.calculateDefaultBatteryLoadedVoltage(
              m_lowerArmSim.get().getCurrentDrawAmps(), m_upperArmSim.get().getCurrentDrawAmps()));
      visualizationUpdate();
    }
  }
