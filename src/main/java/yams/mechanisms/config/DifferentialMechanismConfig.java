...
public class DifferentialMechanismConfig {
  ...
  /**
   * Differential Mechanism configuration class. Required call to {@link
   * #withSmartMotorControllers(SmartMotorController, SmartMotorController)} before usage.
   */
   ...
   *
   * @param MOI Moment of Inertia of the {@link DifferentialMechanism}. In {@link
  ...
  /**
   * Aet the gearing for the differential mechanism if it isnt 1:1. Separate from gearing to the
   * bevel gears.
   *
