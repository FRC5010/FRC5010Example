 ...
 *
 * <ol>
 *   <li>Header — file path, log type (live/replay), and duration
 *   <li>All entries — every signal name and type logged in the file
 *   <li>Numeric statistics — min/max for every double-typed signal
 *   <li>Anomaly flags — loop overruns, gyro/camera disconnects, excessive currents, vision
