...
public class SmartMotorControllerConfig {
  ...
  public SmartMotorControllerConfig withContinuousWrapping(Angle bottom, Angle top) {
    ...
    expoController.ifPresent(
        expoController ->
            expoController.enableContinuousInput(bottom.in(Rotations), top.in(Rotations)));
      ...
      controller.ifPresent(
          profiledPIDController ->
              profiledPIDController.setTolerance(
                  getClosedLoopTolerance().orElse(tolerance).in(Rotations)));
      simpleController.ifPresent(
          pidController ->
  ...
  public SmartMotorControllerConfig withClosedLoopTolerance(Distance tolerance) {
    ...
    if (tolerance != null) {
      ...
      controller.ifPresent(
          profiledPIDController ->
              profiledPIDController.setTolerance(
                  convertFromMechanism(getClosedLoopTolerance().orElse(toleranceAngle))
                      .in(Meters)));
      simpleController.ifPresent(
          pidController ->
   ...
   * @return {@link SmartMotorControllerConfig} for chaining
   * @implNote Please use {@link #withMomentOfInertia(MomentOfInertia)} instead. Default unit is
  ...
  /**
   * Get the Moment of Inertia of the {@link SmartMotorController}'s mechanism for the {@link
   ...
   *     (or Meters if Mechanism Circumference is configured), and output is Voltage.
   * @return {@link SmartMotorControllerConfig} for chaining.
   */
  ...
  /**
   * Set the closed loop controller for the {@link SmartMotorController}, the units passed in are in
   * Rotations (or Meters if Mechanism Circumference is configured), outputs are in Volts.
   *
   * @param controller {@link ProfiledPIDController} to use, the units passed in are in Rotations
   ...
   * profile, the units passed in are in Rotations (or Meters if Mechanism Circumference is
   * configured), outputs are in Volts.
   *
   * @param controller {@link ExponentialProfilePIDController} to use, the units passed in are in
   *     Rotations and output is Voltage.
   * @return {@link SmartMotorControllerConfig} for chaining.
   */
  ...
  /**
   * Set the closed loop controller for the {@link SmartMotorController}, the units passed in are in
   * Rotations (or Meters if Mechanism Circumference is configured), the outputs are in Volts.
   *
   ...
   * Set the closed loop controller for the {@link SmartMotorController}. Units are Meters.
   *
   * @param kP KP scalar for the PID Controller, the units passed in are in Meters and output is
   *     Voltage.
   * @param kI KI scalar for the PID Controller, the units passed in are in Meters and output is
   *     Voltage.
   * @param kD KD scalar for the PID Controller, the units passed in are in Meters and output is
   *     Voltage.
   * @param maxVelocity Maximum linear velocity for the Trapezoidal profile.
   * @param maxAcceleration Maximum linear acceleration for the Trapezoidal profile.
   * @return {@link SmartMotorControllerConfig} for chaining.
