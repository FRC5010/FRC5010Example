...
public class SwerveDriveConfig {
  ...
  //  private       Optional<SelfControlledSwerveDriveSimulation>   mapleDriveSim
  // = Optional.empty();
  ...
  //   * <a
  // href="https://shenzhen-robotics-alliance.github.io/maple-sim/swerve-simulation-overview">MapleSim Docs</a>
  //   *
  ...
  private ChassisSpeeds angularVelocitySkewCorrection(ChassisSpeeds robotRelativeVelocity) {
    var angularVelocity =
        new Rotation2d(
            gyroAngularVelocitySupplier.orElseThrow().get().in(RadiansPerSecond)
