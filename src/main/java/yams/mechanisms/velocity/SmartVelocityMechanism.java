...
public abstract class SmartVelocityMechanism extends SmartMechanism {
  ...
  /**
   * {@link SmartVelocityMechanism} is at max, defined by the soft limit or hard limit on the {@link
   ...
   *
   * @param maximumVoltage Maximum {@link Voltage} to give to the {@link SmartVelocityMechanism}, is
   *     the voltage given to run the {@link SmartVelocityMechanism} up at a static speed.
